...
I am currently an Assistant Researcher in Zhongguancun Laboratory. I received my bachelor's degree from the Department of Computer Science and Technology, Tsinghua University in 2020, supervised by [Prof. Hang Su](https://www.suhangss.me/) and [Prof. Jun Zhu](https://ml.cs.tsinghua.edu.cn/~jun/index.shtml). I received my Ph.D. from the University of Chinese Academy of Sciences in 2025, supervised by [Prof. Shiming Ge](https://imsg.ac.cn/people/geshiming.html) and [Prof. Can Ma](https://people.ucas.ac.cn/~macan), with a joint Ph.D. program in École Polytechnique Fédérale de Lausanne (EPFL) from 2023 to 2024, supervised by [Prof. Tong Zhang](https://sites.google.com/view/tong-zhang) and [Prof. Sabine Süsstrunk](https://people.epfl.ch/sabine.susstrunk?lang=en).
...
Currently, my research focuses on Trustworthy AI and AIGC/LLM/AI Safety, including multimodal media forensics, attack, defense and evaluation of generative models (such as Large Language Models and Diffusion Models).
